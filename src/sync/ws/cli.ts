...
if (values.help) {
  ...
  console.log(`together-code WebSocket signaling server\n\n`
    + `Usage:\n  npx together-code-ws-server@latest [options]\n\n`
    + `Options:\n`
    ...
    + `Examples:\n`
    + `  npx together-code-ws-server@latest\n`
    + `  npx together-code-ws-server@latest -p 9000\n`
    + `  npx together-code-ws-server@latest --port 9000 --hostname 0.0.0.0  # IPv4 only\n`
    + `  npx together-code-ws-server@latest --port 9000 --hostname ::       # Dual-stack\n`)
  process.exit(0)
}
