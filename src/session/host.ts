...
import type { HostSessionState } from './index'
...
export async function createHostSession(config: ConnectionConfig): Promise<HostSessionState> {
  ...
  return scope.run(() => {
    ...
    useWebview().useChat(connection, { role: 'host' })
